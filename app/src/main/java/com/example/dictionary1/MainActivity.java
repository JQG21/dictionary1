...
public class MainActivity extends AppCompatActivity
    ...
    Button insert,del,alt,search,help;
    EditText search_box;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        insert = findViewById(R.id.insert_word);
        del = findViewById(R.id.del_word);
        alt = findViewById(R.id.alt_word);
        search = findViewById(R.id.search);
        help = findViewById(R.id.help);

        search_box = findViewById(R.id.search_box);
        String s_word = search_box.getText().toString();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_search) {//查找
            SearchDialog();
            return true;
        } else if (id == R.id.action_insert) {//新增单词
            InsertDialog();
            return true;
        }
    ...
    private void RefreshWordItemFragment() {
        ItemFragment wordItemFragment = (ItemFragment) getFragmentManager().findFragmentById(R.id.wordslist);
