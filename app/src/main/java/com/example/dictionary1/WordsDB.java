...
public class WordsDB {
    ...
    public Words.WordDescription getSingleWord(String id) {
        ...
        @SuppressLint("Recycle") Cursor cursor = db.rawQuery(sql, new String[]{id});
        if (cursor.moveToNext()) {
            return new Words.WordDescription(cursor.getString(cursor.getColumnIndex(Words.Word._ID)),
